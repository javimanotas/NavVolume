...
\setbeamertemplate{footline}{%
  ...
  \hbox{%
    \begin{beamercolorbox}[wd=.30\paperwidth, ht=2.6ex, dp=1.2ex, leftskip=1em]{pie}%
      \ifdefempty{\apartadoMemoria}{}{%
        \rlap{\raisebox{4.5ex}[0pt][0pt]{\large\color{black}Memoria: páginas \apartadoMemoria}}%
      }%
...
\section{Fundamentos}
\renewcommand{\apartadoMemoria}{6-16}
...
\renewcommand{\apartadoMemoria}{17-22}
...
\renewcommand{\apartadoMemoria}{23}
...
\renewcommand{\apartadoMemoria}{24-26}
...
\renewcommand{\apartadoMemoria}{26-27}
...
\renewcommand{\apartadoMemoria}{58}
\begin{frame}{Desarrollo: Visión general del sistema}
  \begin{center}
...
\renewcommand{\apartadoMemoria}{30-41}
...
\renewcommand{\apartadoMemoria}{41-46}
...
\renewcommand{\apartadoMemoria}{47-48}
...
\renewcommand{\apartadoMemoria}{48-53}
...
\renewcommand{\apartadoMemoria}{54-55}
...
\renewcommand{\apartadoMemoria}{55-58}
...
\renewcommand{\apartadoMemoria}{60}
\begin{frame}{Resultados: Arquitectura modular del sistema}
  \begin{center}
...
\section{Resultados}
\renewcommand{\apartadoMemoria}{60-63}
...
\renewcommand{\apartadoMemoria}{62-65}
...
\renewcommand{\apartadoMemoria}{66-68}
...
\renewcommand{\apartadoMemoria}{69-70}
