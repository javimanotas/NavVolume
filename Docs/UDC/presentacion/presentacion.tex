    ...
    \begin{column}{0.5\textwidth}
      ...
      \begin{tikzpicture}
        \begin{axis}[
            ...
            ymajorgrids, grid style={udcgray!25},
            tick label style={font=\tiny}, label style={font=\scriptsize},
            legend style={at={(0.04,0.96)}, anchor=north west, draw=udcgray!50, font=\tiny},
            legend cell align=left,
          ]
          ...
          \legend{Rasterización, Guardado en disco, Construcción SVO}
        \end{axis}
...
\begin{frame}{Rendimiento: búsqueda de rutas y evasión}
  \begin{columns}[T]
    ...
    \begin{column}{0.5\textwidth}
      ...
      \begin{tikzpicture}
        \begin{axis}[
            ybar, width=\textwidth, height=4.2cm, bar width=8pt,
