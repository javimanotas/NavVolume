...
De este modo, los requisitos funcionales del sistema quedan definidos de forma explícita con su implementación.
...
\begin{itemize}
  ...
  \item \textbf{Desarrollador programador:} escribe el código de juego que consume la \acrshort{api} del sistema para solicitar rutas y realizar consultas espaciales. Trabaja en tiempo de ejecución.
...
\begin{figure}[htp]
  ...
  \begin{tikzpicture}[
    ...
    \node[actorlbl] at (11.2,-3.4) {Desarrollador\\programador};
    ...
    % --- Asociaciones del desarrollador programador ---
  ...
  El diseñador de niveles interactúa con el sistema en tiempo de diseño, mientras que el desarrollador programador y el agente lo hacen en tiempo de ejecución.}
  \label{fig:casos-uso}
\end{figure}
...
\rowcolor{udcpink!25}
\multicolumn{2}{@{}p{12.9cm}@{}}{\textbf{CU-01 \quad Construir el volumen de navegación}}\\
...
\noindent\begin{tabular}{@{}>{\bfseries}p{2.8cm}p{9.9cm}@{}}
\rowcolor{udcpink!25}
\multicolumn{2}{@{}p{12.9cm}@{}}{\textbf{CU-02 \quad Precalcular y persistir el volumen (\textit{bake})}}\\
Actores & Diseñador de niveles. \\
...
\noindent\begin{tabular}{@{}>{\bfseries}p{2.8cm}p{9.9cm}@{}}
\rowcolor{udcpink!25}
\multicolumn{2}{@{}p{12.9cm}@{}}{\textbf{CU-03 \quad Detectar un volumen precalculado obsoleto}}\\
Actores & Diseñadir de niveles. \\
...
\noindent\begin{tabular}{@{}>{\bfseries}p{2.8cm}p{9.9cm}@{}}
\rowcolor{udcpink!25}
\multicolumn{2}{@{}p{12.9cm}@{}}{\textbf{CU-04 \quad Solicitar una ruta navegable entre dos puntos}}\\
Actores & Desarrollador programador, Agente. \\
...
\noindent\begin{tabular}{@{}>{\bfseries}p{2.8cm}p{9.9cm}@{}}
\rowcolor{udcpink!25}
\multicolumn{2}{@{}p{12.9cm}@{}}{\textbf{CU-05 \quad Obtener una trayectoria suavizada y libre de colisiones}}\\
Actores & Desarrollador programador, Agente. \\
...
\noindent\begin{tabular}{@{}>{\bfseries}p{2.8cm}p{9.9cm}@{}}
\rowcolor{udcpink!25}
\multicolumn{2}{@{}p{12.9cm}@{}}{\textbf{CU-06 \quad Generar rutas con holgura para el tamaño del agente}}\\
Actores & Desarrollador programador, Agente. \\
...
\noindent\begin{tabular}{@{}>{\bfseries}p{2.8cm}p{9.9cm}@{}}
\rowcolor{udcpink!25}
\multicolumn{2}{@{}p{12.9cm}@{}}{\textbf{CU-07 \quad Configurar el volumen desde el editor de Unity}}\\
Actores & Diseñador de niveles. \\
...
\noindent\begin{tabular}{@{}>{\bfseries}p{2.8cm}p{9.9cm}@{}}
\rowcolor{udcpink!25}
\multicolumn{2}{@{}p{12.9cm}@{}}{\textbf{CU-08 \quad Depurar el volumen y consultar sus estadísticas}}\\
Actores & Diseñador de niveles. \\
...
\noindent\begin{tabular}{@{}>{\bfseries}p{2.8cm}p{9.9cm}@{}}
\rowcolor{udcpink!25}
\multicolumn{2}{@{}p{12.9cm}@{}}{\textbf{CU-09 \quad Realizar consultas espaciales sobre el volumen}}\\
Actores & Desarrollador programador. \\
...
\noindent\begin{tabular}{@{}>{\bfseries}p{2.8cm}p{9.9cm}@{}}
\rowcolor{udcpink!25}
\multicolumn{2}{@{}p{12.9cm}@{}}{\textbf{CU-10 \quad Solicitar rutas de forma asíncrona}}\\
Actores & Desarrollador programador. \\
...
\noindent\begin{tabular}{@{}>{\bfseries}p{2.8cm}p{9.9cm}@{}}
\rowcolor{udcpink!25}
\multicolumn{2}{@{}p{12.9cm}@{}}{\textbf{CU-11 \quad Evitar colisiones entre agentes en movimiento}}\\
Actores & Agente, Desarrollador programador. \\
