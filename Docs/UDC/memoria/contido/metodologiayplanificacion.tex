...
\begin{figure}[htp]
  ...
  \resizebox{\textwidth}{!}{%
    ...
    \textbf{Hitos} & & & $\blacklozenge$ & & & & $\blacklozenge$ & & & $\blacklozenge$ & & & $\blacklozenge$ & $\blacklozenge$ \\ \hline
    \end{tabular}%
  }
  ...
  Las barras rosadas corresponden a las fases principales y las azuladas a las tareas transversales. Los rombos ($\blacklozenge$) señalan los hitos.}
  \label{fig:gantt}
\end{figure}
...
El presupuesto total, resumido en la Tabla~\ref{tab:presupuesto}, asciende a 4.412,42\,\euro.
...
\begin{figure}[htp]
  ...
  En gris se resaltan las desviaciones respecto al plan inicial (la fase de robustez geométrica y el incremento no planificado de evasión local); en rosado, las fases que se ajustaron a lo previsto; y en azul, las tareas transversales. Los rombos ($\blacklozenge$) señalan los hitos.}
...
La dedicación real ascendió a unas \textbf{400} horas, frente a las 360 previstas, lo que, manteniendo el resto de partidas, eleva el coste total a 4.892,48\,\euro, tal y como recoge la Tabla~\ref{tab:presupuesto-real}.
...
\begin{table}[htp]
  ...
  \rowcolor{udcpink!25}
  \textbf{Concepto} & \textbf{Coste} \\\hline
  Recursos humanos (400\,h $\times$ 11,43\,\euro/h) & 4.572,00\,\euro \\
  Amortización del equipo de desarrollo & 87,50\,\euro \\
  Licencias de software & 0,00\,\euro \\
  Costes indirectos (5\,\%) & 232,98\,\euro \\\hline
  \textbf{Total} & \textbf{4.892,48\,\euro} \\
  \end{tabular}
