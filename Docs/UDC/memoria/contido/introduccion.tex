...
El comportamiento de estas entidades resulta clave para garantizar la credibilidad, funcionalidad y realismo del entorno virtual, especialmente en escenarios complejos y dinámicos.
...
Aunque el escenario se modela en tres dimensiones, el cálculo de rutas se proyecta sobre superficies esencialmente bidimensionales que definen las zonas donde los agentes pueden apoyarse o caminar, tal y como puede apreciarse en la Figura~\ref{fig:navmesh25d}.
...
La necesidad de crear una herramienta que dote a agentes voladores de la capacidad de moverse a través de un espacio plenamente tridimensional surge del limitado soporte que ofrecen las tecnologías dominantes en el desarrollo de videojuegos actual.
...
Por consiguiente, el salto hacia una navegación puramente volumétrica plantea un desafío técnico de considerable magnitud.
...
El objetivo general de este Trabajo de Fin de Grado consiste en el diseño, implementación y validación en el motor Unity de un sistema de navegación volumétrica eficiente y optimizado.
El resultado final tendrá un enfoque de producto, materializándose en un paquete de herramientas modular, de código abierto, listo para su integración inmediata en proyectos y entornos de producción reales.
...
\begin{description}
    \item[Capítulo 1: Introducción.] El presente capítulo.
    \item[Capítulo 2: Fundamentos.] Explica los distintos términos y técnicas requeridas para comprender el proyecto.
    \item[Capítulo 3: Estado de la cuestión.] Examina las soluciones existentes en la literatura y la industria, incluyendo un análisis de \acrfull{dafo}.
    \item[Capítulo 4: Metodología y planificación.] Detalla el modelo de ciclo de vida de software adoptado, así como la planificación temporal y los recursos empleados.
    \item[Capítulo 5: Desarrollo.] Profundiza en las distintas fases involucradas en la implementación del sistema.
    \item[Capítulo 6: Conclusiones.] Sintetiza los resultados obtenidos y evalúa las aportaciones del sistema al desarrollo de videojuegos.
    \item[Capítulo 7: Trabajos futuros.] Propone extensiones y nuevas líneas de investigación que pueden desarrollarse a partir del sistema implementado.
\end{description}
